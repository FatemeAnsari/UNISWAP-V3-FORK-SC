...
import '@dotOne/v3-core/contracts/interfaces/callback/IDotOneV3FlashCallback.sol';
import '@dotOne/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
/// @notice An example contract using the DotOne V3 flash function
contract PairFlash is IDotOneV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `DotOneV3FlashCallback`
    function initFlash(FlashParams memory params) external {
        PoolAddress.PoolKey memory poolKey =
            PoolAddress.PoolKey({token0: params.token0, token1: params.token1, fee: params.fee1});
        IDotOneV3Pool pool = IDotOneV3Pool(PoolAddress.computeAddress(factory, poolKey));
