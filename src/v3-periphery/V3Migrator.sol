...
import '@dotOne/v2-core/contracts/interfaces/IDotOneV2Pair.sol';
...
contract V3Migrator is IV3Migrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        IDotOneV2Pair(params.pair).transferFrom(msg.sender, params.pair, params.liquidityToMigrate);
        (uint256 amount0V2, uint256 amount1V2) = IDotOneV2Pair(params.pair).burn(address(this));
